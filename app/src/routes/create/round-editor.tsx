    ...
    <fieldset className="flex flex-col gap-4" disabled={disabled}>
      ...
      <div aria-live="polite" className="flex flex-col gap-4">
        ...
        {rounds.map((round, index) => {
          ...
          return (
            <div key={index} className="flex flex-col gap-2 rounded-control border border-ink-muted panel-strong p-4">
              ...
              {!keepAny ? (
                <label className="flex flex-col gap-1 text-sm font-semibold" htmlFor={`round-${index}-keep`}>
                  ...
                  <input
                    ...
                    className="w-32 rounded-control border border-ink-muted panel-strong px-3 py-2 text-ink"
                  />
                </label>
              ) : null}
              {keepErrors.length > 0 ? (
